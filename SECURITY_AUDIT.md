...
- **ID:** DOS-05
- **Location:** `src/lib.rs` (middleware stack)
...
- **ID:** FHIR-07
- **Location:** All CRUD handlers in `src/fhir.rs`
...
- **ID:** CRYPTO-01
- **Location:** `src/main.rs`, `Dockerfile`
...
- **ID:** DEPLOY-05
- **Location:** `src/config.rs:24`, `src/auth.rs:79-85`
...
- **ID:** INJ-03
- **Location:** `src/fhir.rs` (create/update handlers)
...
- **ID:** AUTHZ-06
- **Location:** `src/store.rs:64-80` (`INSERT ON CONFLICT DO UPDATE`)
...
- **ID:** FHIR-03, RACE-01
- **Location:** `src/fhir.rs` (update_resource, patch_resource)
...
- **ID:** FHIR-08
- **Location:** `src/store.rs` (upsert overwrites in-place)
...
- **ID:** AUTHZ-01
- **Location:** `src/lib.rs:53` (Scalar/OpenAPI docs route)
...
- **ID:** AUTHZ-03
- **Location:** `src/fhir.rs` (get_metadata handler)
