...
1. Add search (`GET /fhir/:resource_type`) with a minimal baseline and pagination shape.
2. Add E2E tests using disposable Postgres for create/read/update flows and tenant isolation.
3. Harden capability statement details so it advertises current auth, formats, and interaction behavior more precisely.
